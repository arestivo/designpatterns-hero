...
class PumpedStateTest {
    private PumpedState state;
    private Hero hero;
    ...
    void move() {
        state.moveUp();
        Mockito.verify(position, Mockito.times(2)).moveUp();
    }

    @Test
    void eatFood() {
        state.eatFood();
        Mockito.verify(hero, Mockito.times(1)).increaseEnergy(20);
    }
